...
const Admin = () => {
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      ...
      setError('Error al eliminar el usuario. Asegúrate de que el nombre de usuario sea correcto.');
      setSuccess(null);
    }
  };
  ...
  return (
    ...
    >
      ...
      {success && <Typography color="success.main" sx={{ marginTop: 2 }}>{success}</Typography>}
    </Box>
  );
};
